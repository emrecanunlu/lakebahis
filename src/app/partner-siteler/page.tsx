...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "LakeBahis partner ve önerilen bahis siteleri listesi. Güvenilir, lisanslı platformlar — güncel giriş, bonus ve casino rehberleri.",
  path: "/partner-siteler",
  keywords: ["bahis siteleri", "partner siteler", "güvenilir bahis", "LakeBahis partner"],
});
...
export default function PartnerPage() {
  ...
  const itemListJsonLd = {
    ...
    description: "LakeBahis partner ve backlink siteleri",
            ...
            <div className="grid gap-10 lg:grid-cols-[1fr_300px]">
              <article className="prose-mb max-w-none">
                ...
                <p>
                  ...
                  çıkarılmıştır. <strong>LakeBahis</strong> resmi sitesi listenin

      ...
      <JsonLd
        data={[
          webPageJsonLd({
            ...
            description:
              "LakeBahis resmi tanıtım sitesi. Lisanslı canlı bahis, casino, slot, Aviator.",
            path: "/",
          }),
          faqJsonLd(FAQ_ITEMS),
        ]}
          ...
          <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 sm:py-16">
            <div className="grid gap-10 lg:grid-cols-[1fr_260px] lg:items-start">
              <article className="prose-mb max-w-none">
                <h2>LakeBahis Resmi Tanıtım Sitesi</h2>
                <p>
                  <strong>LakeBahis</strong>, Türk bahis ve casino pazarının
                ...
                <p>
                  Bu sayfa, LakeBahis&apos;in <strong>resmi tanıtım sitesi</strong>

...
export const metadata: Metadata = buildMetadata({
  title: "Blog & Rehber",
  description:
    "LakeBahis hakkında rehberler, bonus duyuruları, oyun incelemeleri ve güncel gelişmeler. Spor bahsi, casino, slot ve Aviator stratejileri.",
  path: "/blog",
  keywords: ["LakeBahis blog", "bahis rehberi", "casino ipuçları"],
});

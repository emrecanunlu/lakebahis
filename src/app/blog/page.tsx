...
export const metadata: Metadata = buildMetadata({
  title: "LakeBahis Blog 2026 | Giriş, Bonus ve Casino Rehberleri",
  description:
    "LakeBahis blog: güncel giriş adresi, hoş geldin bonusu, canlı casino, slot oyunları, Aviator stratejileri ve ödeme yöntemleri hakkında güncel yazılar.",
  path: "/blog",
    ...
    <>
      ...
      <JsonLd
        data={[
          webPageJsonLd({
            title: "Blog & Rehber",
            description: "LakeBahis blog yazıları ve rehberler",
            path: "/blog",
          }),
          breadcrumbJsonLd([
            { name: "Anasayfa", path: "/" },

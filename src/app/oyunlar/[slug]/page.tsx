              ...
              <div>
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  <a
                    ...
                    className="inline-flex h-12 cursor-pointer items-center gap-2 rounded-md btn-primary px-6 text-sm font-semibold text-black  transition-transform active:translate-y-px"
                  >
                    Hemen Üye Ol
                    <svg
                      viewBox="0 0 24 24"
              ...
              <div className="space-y-12">
                ...
                <div className="rounded-2xl border border-pink/30 bg-gradient-to-br from-pink/[0.08] to-violet-500/[0.05] p-6">
                  ...
                  <p className="mt-2 text-sm leading-6 text-body">
                    LakeBahis&apos;e üye ol, %100 hoş geldin bonusunu al ve
                  ...
                  <div className="mt-4 flex flex-wrap gap-3">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex h-11 cursor-pointer items-center rounded-md btn-primary px-5 text-sm font-semibold text-black transition-transform active:translate-y-px"
                    >
                      Üye Ol
                    </a>
                    <a

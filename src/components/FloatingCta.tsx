    ...
    <div className="pointer-events-none fixed inset-x-0 bottom-3 z-40 flex justify-center px-4 sm:bottom-5">
      <div className="pointer-events-auto inline-flex items-center gap-2 rounded-full bg-surface-3/90 p-1.5  ring-1 ring-pink/20 backdrop-blur">
        <a
          ...
          className="inline-flex h-10 cursor-pointer items-center gap-2 rounded-full btn-primary px-4 text-sm font-semibold text-black transition-transform active:translate-y-px sm:px-5"
        >
          <svg
            viewBox="0 0 24 24"
            fill="none"
          ...
          <span className="hidden sm:inline">LakeBahis Üye Ol</span>

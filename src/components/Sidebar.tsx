...
function LoginBox() {
  return (
    <SidebarBox title="LakeBahis Giriş">
      ...
      <a
        ...
        className="mt-4 inline-flex h-11 w-full cursor-pointer items-center justify-center rounded-md btn-primary px-4 text-sm font-semibold text-black transition-transform active:translate-y-px"
      >
        Güncel Giriş Yap
      </a>
      <a

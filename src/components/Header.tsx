      ...
      <div className="relative mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3 sm:px-6">
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="hidden h-10 cursor-pointer items-center rounded-md btn-primary px-4 text-sm font-semibold text-black  transition-transform active:translate-y-px sm:inline-flex"
          >
            Üye Ol
          </a>
          <MobileMenu />

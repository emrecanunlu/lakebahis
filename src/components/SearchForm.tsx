    ...
    >
      ...
      <div className="relative flex items-center">
        ...
        {!compact && (
          <button
            type="submit"
            className="absolute right-2 inline-flex h-8 cursor-pointer items-center rounded-md btn-primary px-3 text-xs font-semibold text-black transition-transform active:translate-y-px"
          >
            Ara
          </button>
        )}

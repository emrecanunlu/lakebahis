export const FAQ_ITEMS = [
  {
    q: "LakeBahis güncel giriş adresi nedir?",
    a: "LakeBahis güncel giriş linki lakegrs.link/lakegir adresidir. Bu kalıcı yönlendirme linki domain değişse bile her zaman güncel adrese otomatik yönlendirir; sayfanın üst kısmındaki 'Güncel Giriş Adresi' butonunu da kullanabilirsin.",
  },
  {
    q: "LakeBahis telegram giriş linki nedir?",
    a: "LakeBahis resmi Telegram kanalı t.me/lakegiris adresindedir. Güncel giriş duyuruları, bonus kampanyaları ve adres değişiklikleri buradan anında paylaşılır.",
  },
  {
    q: "LakeBahis hoş geldin bonusu nasıl alınır?",
  ...
  },
  {
    ...
    a: "LakeBahis, Curaçao eGaming lisansı altında 256-bit SSL şifreleme ile hizmet verir. Tüm kullanıcı verileri ve ödemeler uçtan uca korunur.",
  },
];

...
const DEFAULT_OG = "/images/lakebahis.png";
...
export function organizationJsonLd() {
  return {
    ...
    name: SITE.name,
    url: absoluteUrl(),
    logo: absoluteUrl("/images/lakebahis.png"),
...
export function websiteJsonLd() {
  return {
    ...
    url: absoluteUrl(),
    description:
      "LakeBahis resmi tanıtım sitesi. Güncel giriş, bonuslar, oyun rehberleri ve partner siteler.",
...
export function articleJsonLd(opts: {
  ...
  return {
    ...
    publisher: {
      "@type": "Organization",
      name: SITE.name,
      logo: { "@type": "ImageObject", url: absoluteUrl("/images/lakebahis.png") },
    },
    inLanguage: SITE.language,
  };
}

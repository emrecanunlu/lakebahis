...
export const GAMES: Game[] = [
    ...
    faq: [
      {
        ...
        a: "Evet. Seçili maçlarda LakeBahis canlı yayın özelliği sunar. Yayın başlamadan önce hesabında en az 1 TL bakiye olmalı.",
      },
      {
        q: "Cash out nedir?",
    ...
    faq: [
      {
        ...
        a: "Evet. Ezugi ve Pragmatic Live, LakeBahis için Türkçe konuşan krupiyelerin bulunduğu özel masalar sunar. Türkçe rulet, blackjack ve baccarat masaları 7/24 aktiftir.",
      },
      {
  ...
  },
  {
    ...
    intro:
      "Pragmatic Play, NetEnt, Play'n GO, Hacksaw Gaming, Nolimit City ve Push Gaming dahil sektörün önde gelen 40'tan fazla sağlayıcısının tüm oyunları LakeBahis kataloğunda yer alır. Sweet Bonanza, Gates of Olympus, Starlight Princess gibi popüler oyunlardan jackpot ve megaways serisine kadar geniş yelpaze. Demo modu ile ücretsiz deneme imkanı.",
    highlights: [
  ...
  },
  {
    ...
    intro:
      "Anlık çarpan oyunları (crash games) son yıllarda en hızlı büyüyen oyun kategorisi. LakeBahis'te Aviator, JetX, Spaceman, Mines, Plinko ve Dice gibi en popüler crash oyunlarının tamamı oynanabilir. Otomatik cash out, çift bahis ve tur geçmişi gibi profesyonel özelliklerle stratejik oyun deneyimi sunar.",
    highlights: [
